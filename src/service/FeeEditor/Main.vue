  ...
  >
    <section class="fee-editor-body">
      ...
      <ul class="list">
        ...
        <li
          class="item"
          :class="pageData && pageData.payRate.within ? '' : 'disabled'"
        >
          <div class="item-head">
            <p>
              <svg-icon icon="pay_union" />
              <span>银联二维码</span>
            </p>
          </div>
        ...
        <li
          class="item"
          :class="pageData && pageData.payRate.creditCard ? '' : 'disabled'"
        >
          <div class="item-head">
            <p>
              <svg-icon icon="pay_quick" />
              <span>闪付</span>
            </p>
          </div>
          <div class="empty">当前通道不支持</div>
