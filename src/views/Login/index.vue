    ...
    <div @keypress.enter="enterPress" class="container">
      <div class="content">
        <el-row class="account-type" style="margin: auto;">
          <el-col :span="12" class="type-item" :class="params.accountType===2?'active':''" @click.native="params.accountType=2">
            <span>商户</span>
          </el-col>
          <el-col :span="12" class="type-item" :class="params.accountType===1?'active':''" @click.native="params.accountType=1">
            <span>代理商</span>
          </el-col>
        </el-row>
        <el-form>
...
<style scoped lang="less" rel="stylesheet/less">
  ...
  .login {
    ...
    .content {
      ...
      box-shadow: 4px 0 16px rgba(144, 147, 153, .1);
      border-radius: 5px;
      padding: 50px;
      margin: 0 auto;
