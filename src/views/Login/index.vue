<template>
  <div class="login">
    <div @keypress.enter="enterPress" class="container">
      <div class="content">
        <el-row class="account-type" style="margin: auto;" v-if="DEVELOPMENT">
          <el-col
            :span="12"
            class="type-item"
        ...
        <el-form>
          <div class="form-item">
            ...
            <input id="username" v-model="params.account" />
          </div>
  ...
  data() {
    return {
      params: {
        account: "",
        password: "",
        accountType: /admin\/index/i.test(location.pathname) ? 0 : 1
      }
    };
  },
  inject: ["refresh"],
