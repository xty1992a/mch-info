<template>
  <div class="log-table" v-loading="onRequest">
    <PagingTable label="进件管理" v-model="searchQuery" :total="listTotalLength">
      <template slot="set">
      ...
      <el-table
        ...
        <el-table-column label="操作" fixed="right">
          <template slot-scope="scope">
            ...
            <span class="set-btn" @click="reAddMch(scope.row)">重新进件</span>
            <el-dropdown trigger="click" @command="v => commandHandler(v, scope.row)">
              <span class="set-btn ">
