  ...
  <div class="mchInfo-add-main mch-info-page">
    ...
    >
      ...
      <el-form-item label="账户类型" prop="payeeType">
        <el-radio-group v-model="formData.payeeType">
          ...
          <el-radio :label="16" :disabled="formData.businessLicenseType === 1"
            >对公账户</el-radio
          >
          <el-radio :label="32" :disabled="formData.businessLicenseType === 1"
            >非法人</el-radio
          >
        </el-radio-group>
      </el-form-item>
    ...
    <footer class="main-foot">
      ...
      <el-button class="foot-item" @click="saveAndNext"
        >{{ this.checkPaymentId ? "" : "保存并" }}下一步</el-button
      >
    </footer>
  </div>
</template>
